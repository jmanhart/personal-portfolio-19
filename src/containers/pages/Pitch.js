  ...
  return (
    <BasicPage>
        <BasicContainer>
            ...
            <h2>
               A pitch varient forged over decades along the Great Buffalo River in Northern Arkansas.
            </h2>
        </BasicContainer>
        ...
        <BasicContainer>
            ...
            <PitchList>
                <lh><h3>Dealing:</h3></lh>
                <li>Pick a person at random to deal. Dealership proceeds clockwise after each hand.</li>
                <li>Lightly shuffle the cards and deal three (3) at a time to each player until each player has six (6) cards.</li>
                <li>Score pad</li>
            </PitchList>
        </BasicContainer>
        <BasicContainer>
        <PitchList>
            <lh><h3>Resources:</h3></lh>
            <li><a href="https://poorworkingstiff.wordpress.com/2008/06/21/card-game-7-point-partnership-pitch/">7pt Partnership Pitch</a></li>
            <li><a href="https://en.wikipedia.org/wiki/Pitch_(card_game)">Pitch Wiki</a></li>
        </PitchList>
        </BasicContainer>
    </BasicPage>
  );
